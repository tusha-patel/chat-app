...
const ProfilePage = () => {
    const { isUpdateProfile, updateProfile, authUser } = useAuthStore();
    const [selectedImg, setSelectedImg] = useState(null)

    const handleImageUpload = async (e) => {
        let file = e.target.files[0];
        // upload image file reader method
        if (!file) return;
                ...
                <div className="bg-base-300 rounded-xl p-6 space-y-8 ">
                    ...
                    <div className="flex flex-col items-center gap-4 ">
                        ...
                        <p className='text-sm text-zinc-400 '>
                            {isUpdateProfile ? "Uploading..." : "Click the camera icon on update your photo"}
                        </p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <p className='border px-4 py-2.5 bg-base-200 rounded-lg '>{authUser?.email}</p>
                        </div>
                    </div>
